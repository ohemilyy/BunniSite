export default function NotFoundError() {
    return (
        <div className="px-12 flex flex-col gap-x-4 gap-y-8 items-center justify-center">
            ...
            <h1 className="font-AegixHeader text-center text-3xl font-bold">The page that you were looking for couldn't be found. The content that you are looking for may have since been moved or deleted from the site.</h1>
            <Link href="/">
                <a className={`
