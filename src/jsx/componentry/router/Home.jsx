    ...
    useEffect(() => {
        ...
        <div>
            ...
            <div className="flex gap-y-6 flex-col py-6 h-screen items-center bg-gray-900">
                <img src="https://cdn.discordapp.com/attachments/970190545932656690/981591246382452736/unknown.png" alt="My icon" className="w-64 h-64 mt-12 bg-gray-800" style={{ borderRadius: "50%" }} />
